...
class Booking {
    ...
    * 
    * @String.format untuk mengembalikan/menampilkan nilai variabel yang telah di deklarasikan 
    */
    @Override 
...
public class AirlineReservationSystem {
    ...
    static String[] flights = { "Jakarta - Denpasar", "Jakarta - Surabaya", "Jakarta - Medan", "Surabaya - Makassar",
            ...
            "Jakarta - Banda Aceh" };
    /**
     * @setsAvailable untuk menyimpan data kursi perkelas yang tersedia di masing2 rute penerbangan 
     *  
     */
    ...
    /**
     * @booking untuk menyimpan rute penerbangan, kelas penerbangan, maksimal per kelas menampung 6 kuota
     */
